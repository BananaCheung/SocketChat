...
namespace SocketServer
{
    public partial class FormServer : Form
    {
        ...
        {
            lbClients.Items.Add(info);
            lbClients.SelectedIndex = lbClients.SelectedIndex == -1 ? 0 : lbClients.SelectedIndex;
        }
        ...
        private void ServerSendMessage(string sendMsg)
        {
            ...
            {
                string selectClient = lbClients.Text;
        ...
        private void ServerReceiveMessage(object clientParaSocket)
        {
            ...
            while (true)
            {
                ...
                catch (Exception)
                {
                    ...
                    lbClients.Items.Remove(serverSocket.RemoteEndPoint.ToString());
                    serverSocket.Close();
